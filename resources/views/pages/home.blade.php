        ...
        <div class="row align-items-center g-5">
            <div class="col-lg-7">
                ...
                <div class="d-flex flex-wrap gap-3">
                    ...
                    <a href="{{ $settings->homepage_secondary_cta_link ?: route('contact') }}" class="btn btn-outline-light btn-lg rounded-pill px-4">{{ $settings->t('homepage_secondary_cta_label') }}</a>
                </div>
            </div>
            <div class="col-lg-5">
