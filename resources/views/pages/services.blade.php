...
@section('content')
<section class="py-6 bg-soft"><div class="container"><h1 class="mb-3">{{ $page?->t('hero_title') ?: 'Services' }}</h1><p class="lead mb-0">{{ $page?->t('hero_subtitle') ?: 'From strategy to delivery, we design scalable systems that fit your workflow.' }}</p></div></section>
